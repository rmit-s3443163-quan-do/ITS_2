...
<head>
    ...
    <script src="<?= asset_url() ?>tools/js/jquery.loadingbar.min.js"></script>
    <link href="<?= asset_url() ?>tools/css/loadingbar.css" media="screen" rel="stylesheet"/>

    <script src="<?= asset_url() ?>tools/js/notify.min.js"></script>


    <link href="<?= asset_url() ?>tools/css/summernote.css" rel="stylesheet">
