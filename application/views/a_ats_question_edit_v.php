    ...
    <div class="row">
        <div class="col-xs-10">
            <div class="form-group">
                ...
                <input class="hidden-sm" type="hidden" value="<?= $question->text ?>"/>
        ...
        <div class="col-xs-2">
            <div class="form-group">
                ...
                <input type="number" class="form-control"
                       value="<?= $question->mark ?>" placeholder="mark"/>
            </div>
        </div>
        <div class="col-xs-4">
            <div class="form-group">
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <input type="number" class="form-control" value="<?= $question->difficulty ?>" placeholder="1" min="1"
                       max="5"/>
            </div>
        </div>
        <div class="type12">
