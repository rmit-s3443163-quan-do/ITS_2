            ...
            <form>
                ...
                <? foreach ($options as $index => $opt) : ?>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <span class="question_edit"><?= $opt->explain!=''?htmlspecialchars_decode($opt->explain):'not set yet' ?></span>
                ...
                <div class="form-group">
                    ...
                    <div class="question_edit">
                        <? foreach ($courses as $index => $course) : ?>
                            <?= $course->text!=''?$course->text:'not set yet' ?>;
                        <? endforeach; ?>
                    </div>
