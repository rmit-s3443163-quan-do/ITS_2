                ...
                <div class="admin-title">
                    ...
                    <div class="sub-inline">
                        ...
                        <div class="sub-menu">
                            ...
                            <a href="<?= base_url() . 'user_authentication/aoffering'?>">Offering</a>
                        </div>
                        <span class="glyphicon seperate glyphicon-chevron-right"></span>

                        <div class="selected sub-menu">
                            <span class="glyphicon glyphicon-bishop"></span> Topic
                        </div>
                        <span class="glyphicon seperate glyphicon-chevron-right"></span>
                ...
                <div class="row">
                    <div class="col-xs-3">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <p><strong>Offering:</strong> Sem 2, 2015<br/>
                                </p>
                                <hr>
                                <h4>Topic List</h4>
                                <ul>
                    ...
                    <div class="col-xs-3">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <h5>No Offering for this course</h5>
                    ...
                    <div class="col-xs-3 hidden" id="add-form">
                        <div class="panel panel-add">
                            <div class="panel-heading"><span class="glyphicon glyphicon-plus"></span> New Course
                            </div>
                            <div class="panel-body">
                                <input type="text" id="course-title" class="form-control" placeholder="course title"/>
                                ...
                                <button class="btn btn-primary btn-small add-done" type="button">
